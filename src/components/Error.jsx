...
export default function Error() {
    ...
    return (
        <div className={!error ? "error__block": "error-block active"}>
            ...
            <p className="error__ext">Что-то пошло не так</p>
            <div className="error__footer">
                <button className="btn error__btn" onClick={() => setError(false)}>Понятно</button>
            </div>
        </div>
    )
}