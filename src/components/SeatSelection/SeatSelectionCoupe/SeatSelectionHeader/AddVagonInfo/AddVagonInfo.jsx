...
console.log(typeSeats, 'typeSeats')
                        ...
                        (el.coach.class_type === typeSeats ) ?  
                            <>
                                <div key={index} className={`detailed__box ${(toggleState == index) ? 'detailed__box__active' : '' }`}>
                                    ...
                                    <VagonPlacesList type={type} listPlaces={el.seats} vagon={toggleState} price={el.coach.price}/>
                                </div>    
...
//                                         <button 
//                                             key={index} 
//                                             className={`btn vagon__info__number  ${(typeSeats === el.coach.class_type) ? 'vagon__number__active' : '' }`} 
//                                             onClick={(e) => toggleActive(e, index)}>
//                                             {index}
//                                         </button>  
//                             </div> 
...
//                                 <div key={index} className={`detailed__box ${(typeSeats === el.coach.class_type) ? 'detailed__box__active' : '' }`}>
//                                         <div className={`vagon__info__detailed_box ${type}`} >
//                                             <div className='vagon__info__detailed'>
//                                                 <div className='vagon__number'>{index}</div>
//                                                 <div className='vagon__title'>вагон</div>
//                                             </div>
...
//                                                 <div className='vagon__seats__title'>Места <span>{el.coach.available_seats}</span> </div>
//                                                         {(el.coach.bottom_price > 0) && <div className='vagon__seats_lower'>Нижние <span>{Math.round(el.coach.available_seats/3)}</span></div>}
//                                                         {(el.coach.top_price > 0) && <div className='vagon__seats_upper'>Верхние <span>{Math.round(el.coach.available_seats/3)}</span></div>}
//                                                         {(el.coach.side_price !== 0) && <div className='vagon__seats_upper'>Сидячие места <span>{Math.round(el.coach.available_seats/3)}</span></div>}
...
//                                             <div  className='vagon__seats__price__list'>
//                                                 <div className='vagon__seats__price__title'>Стоимость</div>
//                                                     {(el.coach.bottom_price > 0) && <div className='vagon__seats_lower'><span>{el.coach.bottom_price}</span></div>}
//                                                     {(el.coach.top_price > 0) && <div className='vagon__seats_upper'><span>{el.coach.top_price}</span></div>}
//                                                     {(el.coach.side_price !== 0) && <div className='vagon__seats_upper'><span>{el.coach.side_price}</span></div>}
//                                             </div>
...
//                                         <VagonPlacesList type={type} listPlaces={el.seats}/>
//                                     </div>
