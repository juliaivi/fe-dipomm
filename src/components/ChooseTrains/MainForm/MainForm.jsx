        ...
        <div className="main__form_box">
          <div className="jumbotron__banner">
            <div className="main__form__info">
              ...
              {((loadingTrainsList && !errorTrainsList) ||
                (loadingTrainSeats && !errorTrainSeats) ||
                (loadingTrainSeatsBack && !errorTrainSeatsBack)) && <Loader />}
              {((errorTrainsList && !loadingTrainsList) ||
                (!loadingTrainSeats && errorTrainSeats) ||
                (!loadingTrainSeatsBack && errorTrainSeatsBack)) && <Error />}
              {!loadingTrainsList &&
                !errorTrainsList &&
                !loadingTrainSeats &&
                !errorTrainSeats &&
                  ...
                  <div className="registration__stage">
                    <div className="registration__stage__box">
                      ...
                      <div className="status status__passengers">
                        <div
                          className={`stage__passengers ${location.pathname === '/passengers' || location.pathname === '/payment' || location.pathname === '/checkorder' ? 'stage_active' : 'stage'} `}
                        >
                          <div className="operation__name">
                      ...
                      <div className="status status__payment">
                        <div
                          className={`stage__payment ${location.pathname === '/payment' || location.pathname === '/checkorder' ? 'stage_active' : 'stage'}`}
                        >
                          <div className="operation__name">
                      ...
                      <div className="status status__check">
                        <div
                          className={` stage__check ${location.pathname === '/checkorder' ? 'stage_active' : 'stage'}`}
                        >
                          <div className="operation__name">
