    ...
    <>
      {lastRoutes.map((item) => (
        <div
          ...
          onClick={() => ViewTicketInformation(item)}
        >
          ...
          <div className="list__stations">
            <div className="station__names station__names_start">
              {item.departure.from.railway_station_name} вокзал
            </div>
            <div className="station__names station__names_end">
